...
def show_exploration(data):
    ...
    with st.expander("1. Proportion of overstimulated people"):
        ...
        ax1.axis('equal')
        ax1.set_title('Proportion of overstimulated people', fontsize=20)
    ...
    with st.expander("4. Histograms of numerical variables"):
        ...
        plt.suptitle("Histogram of numerical columns in dataset", fontsize=24)
    ...
    with st.expander("8. Overstimulation vs Screen time and Stress"):
        ...
        ax.set_title('Screen time vs Overstimulation', fontsize=20)
        st.pyplot(fig, use_container_width=False)
    ...
    with st.expander("9. Pairplot of selected features"):
        ...
        pairplot_fig.fig.suptitle("Pairplot of selected features", fontsize=24, y=1.02)
